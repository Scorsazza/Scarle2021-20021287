...
namespace MakeSpriteFont
{
    ...
    public static class GlyphPacker
    {
        ...
        private static Bitmap CopyGlyphsToOutput(List<ArrangedGlyph> glyphs, int width, int height)
        {
        ...
        private static void PositionGlyph(List<ArrangedGlyph> glyphs, int index, int outputWidth)
        {
            int x = 0;
            int y = 0;
        ...
        private static int FindIntersectingGlyph(List<ArrangedGlyph> glyphs, int index, int x, int y)
        {
        ...
        private static int CompareGlyphSizes(ArrangedGlyph a, ArrangedGlyph b)
        {
        ...
        private static int GuessOutputWidth(Glyph[] sourceGlyphs)
        {
            int maxWidth = 0;
            int totalSize = 0;
