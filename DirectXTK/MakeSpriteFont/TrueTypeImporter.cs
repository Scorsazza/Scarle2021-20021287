...
namespace MakeSpriteFont
{
    ...
    public class TrueTypeImporter : IFontImporter
    {
        ...
        private const int MaxGlyphSize = 1024;
        ...
        private static Font CreateFont(CommandLineOptions options)
        {
        ...
        private static Glyph ImportGlyph(char character, Font font, Brush brush, StringFormat stringFormat, Bitmap bitmap, Graphics graphics)
        {
        ...
        private static float? GetCharacterWidth(char character, Font font, Graphics graphics)
        {
