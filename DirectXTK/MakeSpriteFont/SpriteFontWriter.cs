...
namespace MakeSpriteFont
{
    ...
    {
        private const string spriteFontMagic = "DXTKfont";

        private const int DXGI_FORMAT_R8G8B8A8_UNORM = 28;
        private const int DXGI_FORMAT_B4G4R4A4_UNORM = 115;
        private const int DXGI_FORMAT_BC2_UNORM = 74;
        ...
        private static void WriteGlyphs(BinaryWriter writer, Glyph[] glyphs)
        {
        ...
        private static void WriteBitmap(BinaryWriter writer, CommandLineOptions options, Bitmap bitmap)
        {
        ...
        private static void WriteRgba32(BinaryWriter writer, Bitmap bitmap)
        {
        ...
        private static void WriteBgra4444(BinaryWriter writer, Bitmap bitmap)
        {
        ...
        private static void WriteCompressedMono(BinaryWriter writer, Bitmap bitmap, CommandLineOptions options)
        {
            if ((bitmap.Width & 3) != 0 ||
                (bitmap.Height & 3) != 0)
            {
        ...
        private static void CompressBlock(BinaryWriter writer, BitmapUtils.PixelAccessor bitmapData, int blockX, int blockY, CommandLineOptions options)
        {
            long alphaBits = 0;
            int rgbBits = 0;
